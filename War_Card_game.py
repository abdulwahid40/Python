...
SUITE = 'Heart  Diamond Spade Club'.split()
...
class Deck:
    ...
    def __init__(self):
        print('Creating new ordered Card')
...
comp = Player('Computer', half_1)
name = input('What is your name: ')
user = Player(name, half_2)
...
while user.still_has_cards() and comp.still_has_cards():
    ...
    if c_card[1] == p_card[1]:
        ...
        c_card = table_cards[len(table_cards)-1:][0]
        table_cards.extend(user.remove_war_cards())
        p_card = table_cards[len(table_cards)-1:][0]
...
print("Does User still has cards? ")
